...
public abstract partial class SharedMedievalMagicSystem : EntitySystem
{
        ...
        bool isContinuation = false)
    {
        ...
        if (ev.Cancelled ||
            _handsSystem.TryGetEmptyHand(performer, out _) == false) // TODO: Если в игре появятся магические катализаторы (посохи, палочки), что дают баффы при сотворении чар, то нужно будет добавить их в исключение
        {
