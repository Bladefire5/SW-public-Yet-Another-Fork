...
ent-MedievalAncientNocturneRevertAction = Превращение в ноктюрна
    .desc = Досрочно вернитесь в свою исходную форму.
ent-MedievalAncientNocturneBat = летучая мышь
    .desc = У неё очень большие клыки и кровожадные красные глаза. Вам не стоит находиться рядом.

ent-MedievalAncientNocturneHypnosisAction = Гипноз
    .desc = Попытайтесь принудить жертву к своей воле и усыпить её.
ent-MedievalAncientNocturneHypnosisProjectile = гипноз
    .desc = Непреодолимый гипнотический импульс.

ent-MedievalBloodRuby = кровавый рубин
    .desc = Белый рубин, ждущий, чтобы его  наполнили кровью
medieval-blood-ruby-donate-verb = Вложить кровь
medieval-blood-ruby-examine = Хранит в себе { $amount } унций крови
...
medieval-ancient-nocturne-mind-connection-wrap-message = { $channel } { $name }: { $message }
...
medieval-ancient-nocturne-event-announcement = На архипелаге были замечены древние ноктюрны! Инквизиция уже направлена по следу
medieval-ancient-nocturne-event-sender = Событие
